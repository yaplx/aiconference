...
# ==============================================================================
# 5. FIRST PASS EVALUATION (GPT-5 - RELEVANCE ONLY)
# ==============================================================================
def evaluate_first_pass(client, paper_title, abstract_text, conference_name):
    ...
    **STRICT GUIDELINES:**
    ...
    - (Ignore novelty or structure issues for this check).
...
def create_pdf_report(full_report_text, filename="document.pdf"):
    ...
    # --- FONT SETUP ---
    # Finds the font in dejavu-sans-ttf-2.37/ttf/ relative to THIS script
